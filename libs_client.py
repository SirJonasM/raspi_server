...
KEM_ALGORITHMS = {
    "kyber512rust": {
        ...
        "kem_algorithm": kyber512rust_lib.encapsulate_key,
    ...
    "kyber768rust": {
        ...
        "kem_algorithm": kyber768rust_lib.encapsulate_key,
    ...
    "kyber1024rust": {
        ...
        "kem_algorithm": kyber1024rust_lib.encapsulate_key,
    ...
    "kyber512": {
        ...
        "kem_algorithm": kyber512_lib.PQCLEAN_KYBER512_CLEAN_crypto_kem_enc,
        "kem_cipher_text_bytes": 768,
        "shared_secret_bytes": 32,
        "kem_public_key_bytes": 800,
        "kem_private_key_bytes": 1632,
    ...
    "kyber768": {
        ...
        "kem_algorithm": kyber768_lib.PQCLEAN_KYBER768_CLEAN_crypto_kem_enc,
        "kem_cipher_text_bytes": 1088,
        "shared_secret_bytes": 32,
        "kem_public_key_bytes": 2400,
        "kem_private_key_bytes": 1184,
    ...
    "kyber1024": {
        ...
        "kem_algorithm": kyber1024_lib.PQCLEAN_KYBER1024_CLEAN_crypto_kem_enc,
        "kem_cipher_text_bytes": 1568,
        "shared_secret_bytes": 32,
        "kem_public_key_bytes": 1568,
        "kem_private_key_bytes": 3168,
    ...
    "hqc-rmrs-128": {
        ...
        "kem_algorithm": hqcrmrs128_lib.PQCLEAN_HQCRMRS128_CLEAN_crypto_kem_enc,
    ...
    "hqc-rmrs-192": {
        ...
        "kem_algorithm": hqcrmrs192_lib.PQCLEAN_HQCRMRS192_CLEAN_crypto_kem_enc,
    ...
    "hqc-rmrs-256": {
        ...
        "kem_algorithm": hqcrmrs256_lib.PQCLEAN_HQCRMRS256_CLEAN_crypto_kem_enc,
...
def generate_keypair(public_key_size, secret_key_size, algo, name):
    ...
    return {"sign_public_key": pk.raw, "sign_private_key": sk.raw}
...
SIGNATURE_ALGORITHMS = {
    "dilithium2": {
        ...
        **generate_keypair(
        ...
        "signature_algorithm": dilithium2_lib.PQCLEAN_DILITHIUM2_CLEAN_crypto_sign_signature,
    },
    "dilithium3": {
        ...
        **generate_keypair(
        ...
        "signature_algorithm": dilithium3_lib.PQCLEAN_DILITHIUM3_CLEAN_crypto_sign_signature,
    },
    "dilithium5": {
        ...
        **generate_keypair(
        ...
        "signature_algorithm": dilithium5_lib.PQCLEAN_DILITHIUM5_CLEAN_crypto_sign_signature,
    },
    "falcon512": {
        ...
        **generate_keypair(
        ...
        "signature_algorithm": falcon512_lib.PQCLEAN_FALCON512_CLEAN_crypto_sign_signature,
    },
    "falcon1024": {
        ...
        **generate_keypair(
        ...
        "signature_algorithm": falcon1024_lib.PQCLEAN_FALCON1024_CLEAN_crypto_sign_signature,
    },
    "rainbowIclassic": {
        ...
        **generate_keypair(
        ...
        "signature_algorithm": rainbowIclassic_lib.PQCLEAN_RAINBOWICLASSIC_CLEAN_crypto_sign_signature,
    },
    "rainbowIIIclassic": {
        ...
        **generate_keypair(
        ...
        "signature_algorithm": rainbowIIIclassic_lib.PQCLEAN_RAINBOWIIICLASSIC_CLEAN_crypto_sign_signature,
    },
    "rainbowVclassic": {
        ...
        **generate_keypair(
        ...
        "signature_algorithm": rainbowVclassic_lib.PQCLEAN_RAINBOWVCLASSIC_CLEAN_crypto_sign_signature,
    },
}
